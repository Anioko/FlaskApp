...
(function () {
	...
	course.getTop = function (elem, isInner) {
	...
	course.getHeight = function (elem) {
		return elem.offsetHeight || elem.scrollHeight;
	};

	course.getWidth = function (elem) {
		return elem.offsetWidth || elem.scrollWidth;
	};

	course.getPageSize = function () {
	...
	function PreviewManager(converter, panels, previewRefreshCallback) {
		...
		var pushPreviewHtml = function (text) {
			...
			var emptyTop = course.getTop(panels.input) - getDocScrollTop();
			...
			var fullTop = course.getTop(panels.input) - getDocScrollTop();
		...
		if (chunk.endTag.length > 1 && chunk.startTag.length > 0) {
			...
			var linkEnteredCallback = function (link) {
				...
				if (link !== null) {
					...
					// would mean a zero-width match at the start. Since zero-width matches advance the string course,
